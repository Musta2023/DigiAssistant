...
1.  **Home Page:** Get an overview of the platform's features and choose your assessment type.
    ...
    ![Home page](app/projectImages/homePageScreen1.png)
    ![Home page](app/projectImages/homePageScreen2.png)
    ![Home page](app/projectImages/homePageScreen3.png)

2.  **Start Assessment:** Provide some basic information about your company to personalize the assessment.

    ![*(Screenshot of the start page)*](app/projectImages/startAssessement.png)

3.  **Conversational Assessment:** Answer a series of adaptive questions in a chat-like interface.

   ![ *(Screenshot of the conversation page)*](app/projectImages/conversatinalAssessement.png)
...
4.  **Results:** View your personalized assessment results, including your digital maturity profile, dimension scores, and an action plan.
    ...
    ![*(Screenshot of the results page)*](app/projectImages/assessementResult1.png)
    ![*(Screenshot of the results page)*](app/projectImages/assessementResult2.png) 
    ![*(Screenshot of the results page)*](app/projectImages/assessementResult3.png)

5.  **PDF Report:** Download a detailed PDF report of your assessment results.

   ![alt text](app/projectImages/result_pdf.png)
